...
export class UserBuilder extends BaseBuilder<UserAggregate, UserViewModel> {
  ...
  private _refreshTokenHash: string | null = null;
  ...
  withRefreshTokenHash(refreshTokenHash: string | null): this {
    this._refreshTokenHash = refreshTokenHash;
    return this;
  }

  withRefreshTokenExpiresAt(refreshTokenExpiresAt: Date | null): this {
  ...
  public override build(): UserAggregate {
    ...
    return new UserAggregate({
      ...
      refreshTokenHash: this._refreshTokenHash
        ? new RefreshTokenHashValueObject(this._refreshTokenHash)
        : null,
      refreshTokenExpiresAt: this._refreshTokenExpiresAt
        ? new DateValueObject(this._refreshTokenExpiresAt)
        : null,
