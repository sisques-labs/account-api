...
} from '@contexts/identity/application/commands/register-user/register-user.command';
import { RegisterUserResult } from '@contexts/identity/application/commands/register-user/register-user.handler';
import { LoginUserDto } from '@contexts/identity/transport/rest/dtos/login-user.dto';
import { RefreshTokenDto } from '@contexts/identity/transport/rest/dtos/refresh-token.dto';
import { RegisterUserDto } from '@contexts/identity/transport/rest/dtos/register-user.dto';
import { setSessionCookies } from '@contexts/identity/transport/shared/session-cookies.helper';
import {
  Body,
  Controller,
  HttpCode,
